...
struct JsAPIHooks
{
    ...
    typedef JsErrorCode(WINAPI *JsrtGetStringLengthSizeT)(JsValueRef value, size_t *stringLength);
    ...
    JsrtGetStringLengthSizeT pfJsrtGetStringLengthSizeT;
...
#define HOOK_JS_API(x) m_jsApiHooks.pfJsrt##x
    ...
    static JsErrorCode WINAPI JsGetStringLengthSizeT(JsValueRef value, size_t *stringLength) { return HOOK_JS_API(GetStringLengthSizeT(value, stringLength)); }
