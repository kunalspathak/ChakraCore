...
INTERNALPROPERTY(NZTypeOfPrototypeObject)  // Used to store the type of the prototype object in the prototype objects slots. Only the types having non-zero inlineSlots are stored in this slot.
INTERNALPROPERTY(ZTypeOfPrototypeObject) // Used to store the type of the prototype object in the prototype objects slots.  Only the types having zero inlineSlots/offsetOfInlineSlots are stored in this slot.
