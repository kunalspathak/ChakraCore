...
namespace Js
{
    ...
    public:
        template<class T, uint InlinePropertySlots> static size_t DetermineObjectSize()
        {
            return sizeof(T) + sizeof(SparseArraySegment<typename T::TElement>) + InlinePropertySlots * sizeof(Var);
        }
